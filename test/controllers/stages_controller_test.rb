...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { duration: @stage.duration, order: @stage.order, scenario_id: @stage.scenario_id } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { duration: @stage.duration, order: @stage.order, scenario_id: @stage.scenario_id } }
